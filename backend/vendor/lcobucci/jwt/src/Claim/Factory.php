    ...
    public function __construct(array $callbacks = [])
    {
        $this->callbacks = array_merge(
            [
                ...
                'eid' => [$this, 'createEqualsTo'],  // DFB: added by me to validate election_id
                'vid' => [$this, 'createEqualsTo'],  // DFB: added by me to validate voter_id
                'uen' => [$this, 'createEqualsTo']   // DFB: added by me to validate url_election_name
            ],
            $callbacks
        );
    }
