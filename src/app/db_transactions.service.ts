...
export class DBTransactions {
    ...
    get_elections(){
        return this.http.get(GlobalConstants.apiURL+"backend/get_elections.php");
    }
    ...
    calc_election(election_id: number){
        return this.http.get<http_response>(GlobalConstants.apiURL+"backend/winner_calc.php?election_id="+election_id);
    }

    get_paths_and_labels(election_id: number){
        return this.http.get<http_response>(GlobalConstants.apiURL+"backend/get_paths_and_labels.php?election_id="+election_id);
    }
}