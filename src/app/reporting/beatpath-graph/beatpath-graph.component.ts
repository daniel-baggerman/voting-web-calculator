...
export class BeatpathGraphComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    for (let i = 0; i < this.sampleLabels.length; i++) {
      this.diagramLabels.push(alphabet.charAt(i));
    }
    ...
    this.drawCanvas(this.my_canvas.nativeElement, {pairwise_data: this.sampleData, labels: this.sampleLabels})
  }
